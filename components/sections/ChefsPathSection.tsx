...
export default function ChefsPathSection() {
  return (
    <GridSection className="bg-beige items-start py-12 md:py-30">
      <AnimatedImage
      ...
      <div className="contents md:order-2 md:col-span-8 md:flex md:h-191 md:flex-col">
        ...
        <Paragraph
          ...
          delay={0.9}
        >
          Сегодня Мехмет — шеф московского ресторана Meat_Coin Steak & Terrace,
          где продолжает дело, начатое его наставниками
        </Paragraph>
      </div>
      ...
      <div className="order-5 col-span-5 mt-10 md:col-span-5 md:col-start-5 md:mt-6">
        ...
        <Paragraph className="text-accent mt-2" delay={1.1}>
          В основе философии Мехмета — три незыблемых принципа безупречный выбор
          мяса, виртуозная разделка и абсолютное понимание открытого огня
        </Paragraph>
      </div>
      ...
      <div className="order-7 col-span-5 md:col-span-7 md:col-start-5">
        <Paragraph className="mb-2" delay={1.3}>
          ...
          точность и диалог <br className="hidden md:block" />с жаром позволяют
          раскрыть глубину вкуса премиальной говядины
        </Paragraph>
        <Paragraph delay={1.4}>
          Путь от первого ресторана
          <br className="md:hidden" /> на Рубинштейна до загородного клуба
          <br className="md:hidden" /> в Комарово —
          <br className="hidden md:block" /> это история роста, дерзости и любви
          к своему делу
        </Paragraph>
      </div>
    </GridSection>
