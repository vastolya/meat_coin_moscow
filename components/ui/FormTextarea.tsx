...
export default function FormTextarea({ resizeIcon, className = '', ...props }: FormTextareaProps) {
  const base =
  ...
  if (resizeIcon) {
    return (
      <div className="relative">
        ...
        <span className="pointer-events-none absolute right-0 bottom-0">{resizeIcon}</span>
      </div>
    )
  }
